        ...
        <div className="animate-fade-in">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Rejoignez LearnAI et accédez à vos formations
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border/50 bg-card/50 p-6 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input id="password" name="password" type="password" required placeholder="6 caractères minimum" className="w-full rounded-lg border border-border/50 bg-background px-4 py-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-purple-500 focus:ring-1 focus:ring-purple-500" />
              </div>
              <div>
                <label htmlFor="confirmPassword" className="mb-1.5 block text-sm font-medium">Confirmer le mot de passe</label>
                <input id="confirmPassword" name="confirmPassword" type="password" required placeholder="Retapez votre mot de passe" className="w-full rounded-lg border border-border/50 bg-background px-4 py-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-purple-500 focus:ring-1 focus:ring-purple-500" />
              </div>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            Déjà un compte ?{" "}
            <Link href="/connexion" className="font-medium text-purple-400 hover:text-purple-300">Se connecter</Link>
          </p>
        </div>
      </section>
    </div>
