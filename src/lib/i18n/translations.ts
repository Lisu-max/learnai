export const translations = {
  fr: {
    ...
    coursesPage: {
      ...
      freeStat: "Formations gratuites",
      formationsStat: "Formations",
      freeSectionTitle: "Formations gratuites",
      freeSectionSubtitle: "Commencez immédiatement, sans inscription ni paiement. 3 formations pour débuter.",
      ...
      chaptersTotal: "chapitres premium",
      perCourse: "/ formation",
    },
    // Course detail
    courseDetail: {
  ...
  en: {
    ...
    coursesPage: {
      ...
      chaptersTotal: "premium chapters",
      perCourse: "/ course",
    },
    courseDetail: {
