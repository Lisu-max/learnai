  ...
  chapters: [
    {
      ...
      videoDurationMinutes: 5, label: "L'Intelligence Artificielle en 5 minutes" },
        ...
        { type: "diagram", label: "Le Cycle de Fonctionnement de l'IA", flow: "horizontal", nodes: [
          { label: "Collecte de donnees", sub: "Grandes quantites de donnees brutes", color: "purple" },
          { label: "Entrainement", sub: "L'algorithme apprend les patterns", color: "blue" },
          { label: "Inference", sub: "Predictions sur nouvelles donnees", color: "emerald" },
        ]},
        { type: "diagram", label: "Grandes Etapes de l'IA", flow: "vertical", nodes: [
          { label: "1956 — Conference de Dartmouth", sub: "Naissance officielle de l'IA", color: "amber" },
          { label: "2012 — AlexNet", sub: "Revolution de la vision par ordinateur", color: "purple" },
          { label: "2017 — Transformers", sub: "Architecture fondatrice des LLM modernes", color: "blue" },
          { label: "2022 — ChatGPT", sub: "Democratisation de l'IA grand public", color: "emerald" },
          { label: "2026 — Agents autonomes", sub: "IA integree dans tous les workflows", color: "pink" },
        ]},
        { type: "summary", items: [
    ...
    },
    {
      ...
      sections: [
        ...
        { type: "diagram", label: "Les 3 Types d'Apprentissage", flow: "horizontal", nodes: [
          ...
          { label: "Non supervise", sub: "Clustering, anomalies", color: "blue" },
          { label: "Renforcement", sub: "Recompenses, essai-erreur", color: "emerald" },
        ]},
        { type: "video", videoId: "R9OHn5ZF4Uo",
      videoDurationMinutes: 9, label: "Le Machine Learning explique simplement" },
        { type: "summary", items: [
    ...
    },
    {
      ...
      videoDurationMinutes: 19, label: "Comment fonctionne un reseau de neurones (3Blue1Brown)" },
        { type: "diagram", label: "Architecture d'un Reseau de Neurones", flow: "horizontal", nodes: [
          { label: "Couche d'entree", sub: "Donnees brutes (pixels, tokens…)", color: "blue" },
          { label: "Couches cachees", sub: "Traitement et representations abstraites", color: "purple" },
          { label: "Couche de sortie", sub: "Prediction ou generation finale", color: "emerald" },
        ]},
        { type: "diagram", label: "Les 3 Catalyseurs du Deep Learning", flow: "horizontal", nodes: [
          ...
          { label: "GPU / TPU", sub: "Puissance de calcul parallele", color: "pink" },
    ...
    },
    {
      ...
      sections: [
        ...
        { type: "diagram", label: "Pipeline du Traitement NLP", flow: "horizontal", nodes: [
          { label: "Tokenisation", sub: "Decoupage du texte en tokens", color: "blue" },
          { label: "Analyse syntaxique", sub: "Structure grammaticale", color: "purple" },
          { label: "Analyse semantique", sub: "Sens et intention", color: "emerald" },
          { label: "Generation", sub: "Production de nouveau texte", color: "amber" },
        ]},
