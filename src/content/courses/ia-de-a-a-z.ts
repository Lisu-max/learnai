...
const content: CourseContent = {
  ...
  chapters: [
    ...
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ["Non étiquetées", "Generees aleatoirement", "Etiquetees avec la bonne réponse", "Creees par l'algorithme lui-même"],
          correctIndex: 2,
    ...
    { number: 12, title: "L'Avenir de l'IA", description: "AGI, tendances 2026-2030, carrières et comment se préparer.", estimatedMinutes: 7, sections: [{ type: "heading", content: "Vers l'Intelligence Artificielle Générale (AGI)" }, { type: "paragraph", content: "L'AGI — une IA capable de comprendre et d'accomplir n'importé quelle tâche intellectuelle humaine — reste le Saint Graal de la recherche. En 2026, nous nous en rapprochons mais ne l'avons pas encore atteinte. Les LLM actuels montrent des capacités impressionnantes mais ont encore des limitations." }, { type: "heading", content: "Tendances 2026-2030" }, { type: "paragraph", content: "Les modèles multimodaux sont déjà la norme. Les agents IA autonomes avec Computer Use transforment les workflows. Les modèles compacts comme Qwen 3.5 9B rivalisent avec des modèles 13x plus gros. L'IA embarquee se développé grâce aux NPU (AMD Ryzen AI 400, Apple Neural Engine)." }, { type: "heading", content: "Carrières en IA" }, { type: "paragraph", content: "Les métiers les plus demandes : ingénieur ML, data scientist, prompt engineer, architecte IA, consultant en transformation IA. Mais au-dela des rôles spécialisés, la maîtrise des outils d'IA est devenue une compétence transversale précieuse dans tous les métiers." }, { type: "tip", content: "Vous n'avez pas besoin de devenir spécialiste en IA pour en bénéficier. Apprendre à utiliser efficacement les outils IA peut significativement augmenter votre productivité et votre valeur sur le marche du travail." }, { type: "diagram", label: "Carrières en IA : du Débutant à l'Expert", flow: "horizontal", nodes: [{ label: "Utilisateur IA", sub: "Maîtrise des outils no-code", color: "blue" }, { label: "Prompt Engineer", sub: "Optimisation des interactions LLM", color: "purple" }, { label: "Développeur IA", sub: "Integrations et agents autonomes", color: "emerald" }, { label: "Chercheur / Architecte", sub: "Conception de modèles et systèmes", color: "amber" }] }, { type: "diagram", label: "Tendances IA 2026-2030", flow: "vertical", nodes: [{ label: "Agents autonomes", sub: "IA qui agit sans supervision constante", color: "purple" }, { label: "Modèles embarques", sub: "IA locale sur smartphones et PC", color: "blue" }, { label: "IA multimodale native", sub: "Texte, image, audio, video intègres", color: "emerald" }, { label: "Vers l'AGI", sub: "Intelligence générale : horizon a définir", color: "pink" }] }, { type: "summary", items: ["L'AGI reste un objectif de recherche majeur mais n'est pas encore atteinte", "Tendances : agents autonomes, modèles compacts, IA embarquee", "Les carrières en IA sont nombreuses et bien rémunérées", "La maîtrise des outils IA est une compétence transversale précieuse", "L'apprentissage continu est la clé du succès dans l'ère de l'IA"] }], quiz: [{ question: "Que signifie AGI ?", options: ["Artificial Général Intelligence", "Advanced GPU Infrastructure", "Automated Google Intégration", "Applied Gradient Iteration"], correctIndex: 0, explanation: "AGI signifie Artificial Général Intelligence — une IA hypothetique capable d'accomplir n'importé quelle tâche intellectuelle humaine." }, { question: "Quelle est une tendance majeure de l'IA en 2026 ?", options: ["L'IA remplace tous les emplois", "Les modèles compacts rivalisent avec les gros modèles", "L'IA n'est plus utilisée", "Les coûts augmentent"], correctIndex: 1, explanation: "Des modèles compacts comme Qwen 3.5 9B rivalisent avec des modèles 13x plus gros, democratisant l'accès à l'IA performante." }, { question: "Quel métier est directement lie à l'IA ?", options: ["Plombier", "Prompt engineer", "Pharmacien", "Architecte batiment"], correctIndex: 1, explanation: "Le prompt engineer est un métier directement lie à l'IA, spécialisé dans la création de prompts optimises pour obtenir les meilleurs résultats des modèles IA." }, { question: "Quelle est la clé du succès dans l'ère de l'IA ?", options: ["Éviter l'IA", "Memoriser des formules", "L'apprentissage continu et l'adaptabilite", "Avoir le meilleur matériel"], correctIndex: 2, explanation: "L'IA évolue très rapidement. L'apprentissage continu et l'adaptabilite sont les compétences les plus précieuses pour rester pertinent." }] },
  ],
};
