...
para("Les modeles ont une limite de tokens (fenetre de contexte) qui inclut votre prompt ET la reponse. GPT-4o a un contexte de 128K tokens, Claude 3.5 de 200K tokens. Si votre prompt est trop long, il « consomme » de l'espace qui aurait pu etre utilise pour la reponse. Optimisez la longueur de votre prompt : assez long pour etre precis, assez court pour etre efficace.");
...
summaryBox(["Les prompts sont tokenises avant traitement", "Gerez votre budget de tokens : prompt + reponse", "Placez les infos critiques au debut et a la fin", "Structurez les longs prompts pour eviter le 'lost in the middle'"]);
...
promptExample("Prompt Midjourney", "'A serene Japanese garden in autumn, golden maple leaves reflecting in a koi pond, soft morning light filtering through mist, hyperrealistic photography, Canon EOS R5, 85mm lens, shallow depth of field --ar 16:9 --v 6.1 --s 750'", "Image photoreaiste detaillee avec ambiance specifique");
