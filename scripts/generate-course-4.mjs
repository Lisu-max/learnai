...
para("En mars 2026, le marche mondial de l'IA est estime a plus de 250 milliards de dollars, avec une croissance annuelle de 35%. Plus de 85% des entreprises du Fortune 500 utilisent l'IA generative dans au moins un processus. Le nombre d'outils IA disponibles depasse les 15 000. L'adoption par les PME a triple en deux ans. La semaine du 5 mars 2026 a vu le lancement simultane de plus de 12 modeles majeurs (GPT-5.4, Gemini 3.1, Qwen 3.5), illustrant l'acceleration du rythme d'innovation.");
para("Les couts d'utilisation de l'IA ont drastiquement baisse. Les API d'OpenAI, Anthropic et Google coutent 10-20x moins cher qu'en 2024. Les modeles open source (LLaMA 4, Mistral, Qwen 3.5, DeepSeek) permettent aux entreprises de deployer l'IA sans frais de licence — le modele Qwen 3.5 9B rivalise avec des modeles 13x plus gros. Le cloud computing offre des GPU a la demande a des prix accessibles, et Nvidia a devoile sa plateforme Vera Rubin pour les modeles a un trillion de parametres.");
...
summaryBox(["Marche de l'IA : 250+ milliards $ en 2026, croissance de 35%/an", "Couts divises par 10-20x en 2 ans, modeles open source performants", "85% du Fortune 500 utilise l'IA generative", "Marketing, vente, service client et developpement les plus impactes"]);
...
para("Les chatbots IA de 2026 n'ont plus rien a voir avec les chatbots frustrants du passe. Propulses par des LLM comme GPT-5.4 et Claude 4.6, avec des contextes d'1 million de tokens et des capacites de Computer Use, ils comprennent le langage naturel, gerent des conversations complexes, accedent aux bases de donnees clients, executent des actions dans vos systemes, et resolvent la majorite des demandes de maniere autonome. Le taux de resolution automatique atteint regulierement 70-85% pour les entreprises bien configurees.");
...
doc.moveDown(2);
para("Les agents IA autonomes transforment deja les workflows d'entreprise en mars 2026 : Claude 4.6 peut maintenir une tache pendant 14,5 heures, GPT-5.4 dispose du Computer Use natif. Un agent peut gerer un projet complet, de la planification a l'execution, avec supervision humaine minimale. La « capacite agentique » est devenue le critere numero un des nouvelles releases — chaque modele est desormais concu pour agir, pas seulement repondre.");
para("Les modeles IA specialises par industrie (sante, finance, juridique, retail) offrent des performances superieures aux modeles generiques. Les modeles compacts comme Qwen 3.5 9B rivalisent avec des modeles 13x plus gros, rendant le deploiement on-premise viable meme pour les PME. L'IA on-premise et edge computing permettent de deployer sans envoyer les donnees dans le cloud — renforce par les NPU integres dans les processeurs AMD Ryzen AI 400. La regulation (AI Act) se structure, creant un cadre plus clair.");
summaryBox(["Agents IA autonomes deja operationnels (Claude 4.6 : 14,5h, GPT-5.4 : Computer Use)", "Modeles compacts rivalisent avec les geants (Qwen 3.5 9B vs modeles 13x plus gros)", "NPU dans les processeurs pour l'IA on-premise (AMD Ryzen AI 400)", "L'AI-native disrupe les acteurs etablis dans chaque secteur", "Investissez maintenant pour etre positionne en 2030"]);
